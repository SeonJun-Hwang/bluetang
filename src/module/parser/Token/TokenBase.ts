...
import { Content, TokenOption, Properties, Nullable } from '~global/types';
...
abstract class TokenBase {
  ...
  public getAnimation(): Nullable<Array<Animation>> {
    ...
    const result = [myAnimation, ...childrenAnimation] as Animation[];
    const filtered = _.compact<Animation>(result);
  ...
  protected createElement(): Element {
    const $el = $c(this.tag, this.properties!);
